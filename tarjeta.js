...
export const crearTarjeta = (datos) => {
    ...
    <iframe width="100%" height="100%"  src="https://www.youtube.com/embed/${datos.videos.results[0].key}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
    ` ;
